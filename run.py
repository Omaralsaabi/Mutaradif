...
def main(args):
    ...
    best_synonyms = synonym_generator.best_synonyms(args.word, args.model, args.num_synonyms, args.similarity_threshold)
    print(best_synonyms)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--similarity_threshold', type=float, default=0.9, help='Cosine similarity threshold for selecting best synonyms')
